  ...
  <q-layout view="lHh Lpr lFf">
    <q-header elevated>
      ...
      <div class="q-px-lg q-pt-xl q-mb-md">
        <div class="text-h3">ToDo Morozov</div>
        <div class="text-subtitle">{{ TodayDate }}</div>
      </div>
      <q-img 
      class="header-image absolute-top"
      src="../assets/8168_deer-mountain-landscape_3840x2160 1.svg" />
    </q-header>
        ...
        <q-img class="absolute-top image" style="height: 185px">
          <div class="absolute-bottom bg-transparent">
            <q-avatar size="56px" class="q-mb-sm">
              <img src="../assets/photo_2022-11-08_22-13-12.jpg">
            </q-avatar>
            <div class="text-weight-bold">Morozov Vladislav</div>
            <div>vladanalyst@gmail.com</div>
          </div>
        </q-img>
      </q-drawer>
